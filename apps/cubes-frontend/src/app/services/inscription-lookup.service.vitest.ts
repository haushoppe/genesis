...
describe('InscriptionLookupService', () => {
  ...
  it('returns the id from ord-proxy on success', async () => {
    ...
    const req = httpMock.expectOne('https://ord.ordpool.space/inscription/12345');
  ...
  it('returns null when ord-proxy returns no id', async () => {
    ...
    httpMock.expectOne('https://ord.ordpool.space/inscription/99999').flush({});
  ...
  it('returns null on HTTP error', async () => {
    ...
    httpMock
      .expectOne('https://ord.ordpool.space/inscription/404')
