 ...
 * @notice This contract handles minting and loaning of sea tokens.
 */
contract SeaToken is ERC721AForLendable, ReentrancyGuard, Ownable, Pausable, ERC2981, ILendable, ITermsAndConditions {
    ...
    string private _changeableName = "At the sea by HAUS HOPPE";
    string private _changeableSymbol = "SEA";
